...
namespace SimpleStore.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(SimpleStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Products != null ? 
                ...
                Problem("Entity set 'SimpleStoreContext.Product'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SimpleStoreContext.Product'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            var orders =  _context.Orders.Where(o => o.Product == product);
            if (product != null)
            {
                if(orders.Any())
                {
